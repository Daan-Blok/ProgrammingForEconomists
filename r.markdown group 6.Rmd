...
author: "Daan Blok (2821386), Daniel ten Broeke (), Dries A. M. Berns (), Kon Ntovas (), Mariah P. Mendoza (), Sofie A. Hopman (2745673), Vlad A. Partenie ()" 
date: "`r Sys.Date()`" 
output: pdf_document
---
...
Programming for Economists Group 6

Student names: Daan Blok (2821386), Daniel ten Broeke (), Dries A. M. Berns (), Kon Ntovas (), Mariah P. Mendoza (), Sofie A. Hopman (2745673), Vlad A. Partenie () 
...
Three external datasets are retrieved directly from CBS via the internet, using a predefined vector of dataset codes to automate access and ensure reproducibility. The specific codes used are listed in the corresponding vector. These datasets are compiled by CBS using a combination of integral administrative sources and, in some cases, survey data. For example, the Integrale inkomens- en vermogensstatistiek (86004NED) is based on comprehensive records from institutions such as the Belastingdienst (Dutch Tax Authority), Dienst Uitvoering Onderwijs (DUO), Uitvoeringsinstituut Werknemersverzekeringen (UWV), and the Basisregistratie Personen (BRP). The Huizenprijsindex bestaande koopwoningen (83625NED) relies on transaction data from the Kadaster, which is updated monthly and considered immediately final. Meanwhile, the Stelsel van Sociaal-statistische Bestanden (71488NED) draws primarily on administrative registrations, but also incorporates data from the Enquête Beroepsbevolking (EBB – Labour Force Survey). These sources ensure the statistical accuracy and reliability of the CBS datasets used in this analysis.
...
list(p1, p3, p5, p6, p8) %>% walk(~ print(.x + my_theme))
```
...
This visualization is directly relevant to the topic of housing affordability, as it highlights how a major economic event can temporarily alter housing price dynamics. The post-crisis acceleration in prices, despite income growth remaining comparatively modest, suggests that affordability pressures intensified after 2008. Understanding such event-driven changes is critical for analyzing the temporal fluctuations and risks inherent in the housing market. \# Part 4 - Discussion

## 4.1 Discuss your findings

In this report, we examined how the affordability of housing in the Netherlands is developing in relation to income levels, geographical differences and demographic characteristics. The CBS data used provides insight into both absolute and relative trends in house prices and standardised incomes. By creating new variables such as the HousePriceIndex, IncomeLevelIndex and the Ratio (house price/income index), we were able to quantify these developments.

The temporal visualisations show that average house prices in the Netherlands have risen significantly since 2013, while standardised income has increased to a lesser extent over the same period. As a result, the Ratio of house price to income has been structurally above the reference line of 1 since 2013. This implies a deterioration in the affordability of housing, with house prices rising faster than household income. The visualisation of both indices clearly shows this gap over time.

The regional visualisations show that there are significant geographical differences in both house prices and incomes. The most expensive provinces are concentrated in the Randstad (North Holland, Utrecht, South Holland), while the lowest prices are found in peripheral areas such as Groningen and Zeeland. Although income levels also vary by province, this variation is less pronounced than for house prices. This points to greater pressure on affordability in provinces with high house prices and relatively moderate incomes.

The analysis of subpopulations shows that the proportion of young adults living independently declined in the period 2004–2024, while older people are more likely to continue living on their own. This has implications for the availability of housing for young people. In addition, the distribution of standardised income per housing type shows that tenants—with or without housing benefit—have structurally lower incomes than homeowners, with an increasing difference in absolute terms. These patterns underline that affordable housing is particularly problematic for younger and lower income groups.

Finally, the event analysis of the 2008 financial crisis shows that this event marked a clear break in the development of house prices. Although prices initially fell or stagnated, an accelerated rise set in after 2013, contributing to the current problems in the housing market. The visualisation illustrates how external macroeconomic shocks can have long-term effects on house prices and thus on affordability.

In summary, this analysis shows that the affordability of housing in the Netherlands is under structural pressure, with clear temporal trends, regional inequalities and differences between population groups. The variables and visualisations used provide quantitative support for the social problem outlined in the introduction: a growing group of vulnerable households, especially young people and lower income groups, have increasingly less access to affordable housing.

# Part 5 - Reproducibility

## 5.1 Github repository link

Provide the link to your PUBLIC repository here: Github link: <https://github.com/Daan-Blok/ProgrammingForEconomists.git>

## 5.2 Reference list

Use APA referencing throughout your document.

Wat zijn gevolgen van de onzekere woningmarkt voor jongeren? \| Nederlands Jeugdinstituut. (z.d.-b). <https://www.nji.nl/op-jezelf-wonen/wat-zijn-gevolgen-van-de-onzekere-woningmarkt-voor-jongeren>

Wiesel, I., Ralston, L., & Stone, W. (2021). Understanding after-housing disposable income effects on rising inequality. Housing Studies, 38(2), 290–306. <https://doi.org/10.1080/02673037.2021.1882661> CBS Statline. (z.d.). <https://opendata.cbs.nl/>

Schilder, F., Scherpenisse, R., PBL Netherlands, & Tiwos. (z.d.). Affordable housing in the Netherlands. <https://www.pbl.nl/sites/default/files/downloads/PBL2018_Policy-and-practice-affordable-housing-in-the-Netherlands_3336_0.pdf>

<https://www.cbs.nl/nl-nl/onze-diensten/methoden/onderzoeksomschrijvingen/korte-onderzoeksbeschrijvingen/integraal-inkomens-en-vermogensonderzoek> 86004NED

De cijfers in deze tabel zijn direct definitief. De berekening van deze cijfers is gebaseerd op het aantal notaristransacties dat iedere maand door het Kadaster wordt vastgesteld. Een revisie van de cijfers vindt alleen bij uitzondering plaats 83625NED

<https://www.cbs.nl/nl-nl/onze-diensten/methoden/onderzoeksomschrijvingen/korte-onderzoeksomschrijvingen/stelsel-van-sociaal-statistische-bestanden--ssb--> 71488ned
